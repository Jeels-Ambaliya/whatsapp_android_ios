...
import 'package:whatsapp_android_ios/pages/model/globals.dart';
...
class _WhatsappState extends State<Whatsapp> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: Globals.myTabs.length, vsync: this);
  }
